...
class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      console.log('Error logged to reporting service:', {
        error: error.message,
        stack: error.stack,
          ...
          <Card className="w-full max-w-md border-red-200 bg-red-50/50">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-red-800 text-xl">
                Kuch gadbad ho gayi {String.fromCodePoint(0x1F61A)}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-center">
              <p className="text-red-700 text-sm">
                Arre bhai! Kisi cheez mein technical problem aa gayi hai. 
                Thodi der mein try karte hain.
              </p>
              
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="text-left text-xs text-red-600 bg-red-100 p-3 rounded border border-red-200">
